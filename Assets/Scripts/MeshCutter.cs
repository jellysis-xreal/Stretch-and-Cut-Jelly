...
public class MeshCutter : MonoBehaviour
{
    ...
    public List<GameObject> cuttedObjects;
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        Vector3 transformedNormal =
            ((Vector3)(other.gameObject.transform.localToWorldMatrix.transpose * normal)).normalized;
        ...
        Vector3 newNormal = transformedNormal + Vector3.up * _forceAppliedToCut * -1;
        ...
        LeftHand.interactablesSelected.Add(slices[0].GetComponent<XRGrabInteractable>());
        RightHand.interactablesSelected.Add(slices[1].GetComponent<XRGrabInteractable>());
        if (LeftHand.interactablesSelected.Count > 0)
            Debug.Log(LeftHand.firstInteractableSelected);  
        if (RightHand.interactablesSelected.Count > 0)
            Debug.Log(RightHand.firstInteractableSelected);
        */
